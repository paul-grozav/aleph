...
sudo qemu-system-x86_64 -m 3G -smp 8 -display none -serial stdio \
  ...
  -append "enforcing=1 ifname=eth1:52:55:00:d1:55:04 ip=10.0.2.16::10.0.2.2:255.255.255.0:myhostname:eth1:none nameserver=8.8.8.8 nomodeset console=ttyS0,115200n8 config_srv_url=http://172.21.183.215:8080/ rooturl=http://172.21.183.215:8080/target.squashfs" \
